...
L.appearance_shadow = "阴影风格"
L.appearance_shadow_tooltip = "界面元素添加外围阴影。"
L.appearance_gradient = "渐变风格"
L.appearance_gradient_tooltip = "部分界面元素使用渐变效果。"
L.appearance_subCategory_misc = "其他"
L.appearance_questTracker = "任务追踪栏"
L.appearance_questTracker_tooltip = "美化任务追踪栏，禁用此项如果你要使用其他任务追踪栏插件。"
L.appearance_petBattle = "宠物对战界面"
L.appearance_petBattle_tooltip = "美化宠物对战界面，禁用此项如果你要使用其他宠物对战类的插件。"
...
L.appearance_DBM = "DBM"
L.appearance_DBM_tooltip = "DBM"
L.appearance_BigWigs = "BigWigs"
L.appearance_BigWigs_tooltip = "BigWigs"
L.appearance_WeakAuras = "WeakAuras"
L.appearance_WeakAuras_tooltip = "WeakAuras"
L.appearance_PremadeGroupsFilter = "Premade Groups Filter"
L.appearance_PremadeGroupsFilter_tooltip = "Premade Groups Filter"
L.appearance_Skada = "Skada"
L.appearance_Skada_tooltip = "Skada"



L.automation = "便利功能"
L.automation_subText = "这些设置帮助玩家自动执行一些常用动作。"
L.automation_subCategory_automation = "基本设定"
L.automation_autoSellJunk = "出售"
L.automation_autoSellJunk_tooltip = "打开商人窗口时自动出售灰色品质无用物品。"
L.automation_autoScreenShot = "自动截图"
L.automation_autoScreenShot_tooltip = "获得成就时自动截图。"
L.automation_autoSetRole = "自动设定职责"
L.automation_autoSetRole_tooltip = "自动设定职责。"
L.automation_autoRepair = "自动修理"
L.automation_autoRepair_tooltip = "打开商人窗口时自动修理装备。"
L.automation_autoQuest = "自动交接任务"
L.automation_autoQuest_tooltip = "与任务NPC交互时自动交接任务，按住Ctrl键点击NPC则暂时禁用自动交接功能。"
L.automation_autoBuyStack = "自动购买整组"
L.automation_autoBuyStack_tooltip = "按住Shift点击物品自动购买整组。"
L.automation_autoTabBinder = "自动切换目标选择方式"
L.automation_autoTabBinder_tooltip = "战场/竞技场中自动切换Tab键为选择敌对玩家而忽略宠物。"
L.automation_autoAcceptInvite = "自动进组"
L.automation_autoAcceptInvite_tooltip = "自动接受来自公会或好友的组队邀请。"
L.automation_autoInvite = "自动邀请"
L.automation_autoInvite_tooltip = "自动邀请使用关键字密语的玩家，默认关键字（invite）。\n/ainv 关键字 （更换关键字）\n/ainv off （禁用自动邀请）"
...
L.notification_checkMail = "邮件"
L.notification_checkMail_tooltip = "收到新邮件时触发通知框。"
L.notification_checkBagsFull = "背包"
L.notification_checkBagsFull_tooltip = "背包满了触发通知框。"
L.notification_autoRepairCost = "修理"
L.notification_autoRepairCost_tooltip = "修理装备后触发通知框提示修理花费。"
L.notification_autoSellJunk = "出售"
L.notification_autoSellJunk_tooltip = "自动出售垃圾后触发通知框提示获得金币。"
...
L.notification_subCategory_rares = "稀有相关"
L.notification_rare = "稀有"
L.notification_rare_tooltip = "附近发现稀有怪物或者事件时提示。"
L.notification_rareSound = "声音"
L.notification_rareSound_tooltip = "播放声音提示。"
L.notification_subCategory_quest = "任务相关"
L.notification_questNotifier = "任务通告"
L.notification_questProgress = "进度"
L.notification_onlyCompleteRing = "完成"
...
L.infobar_skadaHelper = "Skada助手"
L.infobar_skadaHelper_tooltip = "左键显示Skada窗口\n右键隐藏Skada窗口\n中键清除Skada数据"
L.infobar_specTalent = "天赋/专精"
L.infobar_specTalent_tooltip = "显示天赋专精\n左键切换专精\n右键切换拾取专精"
L.infobar_friends = "好友"
L.infobar_friends_tooltip = "显示好友在线信息。"
L.infobar_currencies = "货币"
L.infobar_currencies_tooltip = "显示各类货币以及相关统计。"
L.infobar_report = "日常/周常信息"
L.infobar_report_tooltip = "显示日常/周常/副本进度/突袭等信息。"
...
L.actionbar_petBar_tooltip = "启用宠物动作条。"
...
L.actionbar_bar3_tooltip = "显示 bar3，界面设置/动作条里的右下方动作条"
...
L.inventory_useCategory = "物品分类"
L.inventory_useCategory_tooltip = "启用物品分类，不同种类的物品归纳到不同的背包。"
L.inventory_gearSetFilter = "装备方案"
L.inventory_gearSetFilter_tooltip = "已保存的装备方案作为一个单独的分类来归纳。"
...
L.inventory_mechagonItemFilter = "麦卡贡相关"
L.inventory_mechagonItemFilter_tooltip = "麦卡贡相关的物品作为一个单独的分类来归纳。"
...
L.chat_useOutline = "字体描边"
L.chat_useOutline_tooltip = "给聊天框的文字添加描边。"
...
L.chat_itemLinks = "装备链接增强"
L.chat_itemLinks_tooltip = "为装备链接添加图标/装等/部位/宝石等详细信息。"
L.chat_spamageMeter = "伤害统计数据简化"
L.chat_spamageMeter_tooltip = "把伤害统计类插件输出的数据简化为一个可点击的链接。"
L.chat_chatButton = "功能按钮"
L.chat_chatButton_tooltip = "在聊天框左下角添加一个小按钮，左键点击隐藏整个聊天框，右键点击加入/离开世界频道，中键复制聊天内容。"
L.chat_fading = "文字淡化"
L.chat_fading_tooltip = "如果聊天框一段时间没有收到新信息则旧信息会逐渐淡化消失。"
L.chat_filters = "内容过滤"
L.chat_filters_tooltip = "自动过滤重复或者无用的信息。"
L.chat_autoBubble = "聊天气泡"
L.chat_autoBubble_tooltip = "团本外自动禁用聊天气泡。"
...
L.map_coords = "显示坐标"
L.map_coords_tooltip = "在世界地图的左下方显示玩家当前位置坐标值和鼠标所在位置坐标值。"
L.map_mapReveal = "清除迷雾"
L.map_mapReveal_tooltip = "在世界地图上清除未探索区域的迷雾。"
L.map_subCategory_miniMap = "小地图"
L.map_miniMap = "启用小地图增强"
L.map_miniMap_tooltip = "禁用该项如果你想要使用其他的小地图类插件。"
...
L.map_microMenu_tooltip = "鼠标中键点击小地图显示游戏菜单。"
L.map_marker = "世界标记"
L.map_marker_tooltip = "组队时小地图左下角显示世界标记按钮。"
L.map_progressBar = "进度监控"
L.map_progressBar_tooltip = "小地图上方添加一个进度条监控当前的经验/声望/荣誉进度。"
...
L.tooltip_tipIcon = "图标"
L.tooltip_tipIcon_tooltip = "鼠标提示显示相应的图标"

L.tooltip_ilvlSpec = "装等专精"
L.tooltip_ilvlSpec_tooltip = "显示装等和专精信息。"

L.tooltip_ilvlSpecByShift = "按住shift显示"
L.tooltip_ilvlSpecByShift_tooltip = "只有按住shift才会显示装等和专精信息。"

L.tooltip_linkHover = "装备链接"
L.tooltip_linkHover_tooltip = "鼠标悬停聊天栏的装备链接时显示鼠标提示。"
L.tooltip_extraInfo = "显示额外的信息"
L.tooltip_extraInfo_tooltip = "鼠标提示显示额外的信息比如技能物品的id。"
L.tooltip_extraInfoByShift = "按住shift显示"
L.tooltip_extraInfoByShift_tooltip = "只有按住shift才会显示额外信息。"
L.tooltip_azeriteTrait = "艾泽里特特质"
L.tooltip_ilvlSpec_tooltip = "清理艾泽里特特质信息，只显示图标。"
...
L.unitframe_healer_layout = "治疗布局"
L.unitframe_healer_layout_tooltip = "对治疗职业更友好的对称布局，小队/团队框体集中在屏幕中下部。"
...
L.unitframe_threat = "仇恨提示"
L.unitframe_threat_tooltip = "小队/团队框体周围的光晕提示仇恨。"
L.unitframe_rangeCheck = "距离提示"
L.unitframe_rangeCheck_tooltip = "超出距离的框体淡化。"
L.unitframe_overAbsorb = "吸收提示"
L.unitframe_overAbsorb_tooltip = "血条右侧的白光说明有吸收伤害的效果存在。"
L.unitframe_healPrediction = "治疗提示"
L.unitframe_healPrediction_tooltip = "在血量条上显示即将到来的治疗。"
L.unitframe_dispellable = "驱散提示"
L.unitframe_dispellable_tooltip = "如果小队/团队成员中了你可以驱散的减益效果，该成员的框体会高亮提示，高亮颜色取决于减益效果的类型。"

L.unitframe_quakeTimer = "震荡提示"
L.unitframe_quakeTimer_tooltip = "显示震荡计时条。"
L.unitframe_classPower = "职业资源"
L.unitframe_classPower_tooltip = "显示职业特殊资源条，比如连击点/神圣能量/灵魂碎片。"
L.unitframe_stagger = "醉拳减伤"
L.unitframe_stagger_tooltip = "显示酒仙的醉拳减伤条。"
L.unitframe_totems = "图腾计时"
L.unitframe_totems_tooltip = "显示萨满的图腾计时条。"
...
L.unitframe_enableBoss = "启用首领框体"
L.unitframe_enableBoss_tooltip = "禁用此项如果你想要使用其他的首领框体类插件。"
L.unitframe_bossColourSmooth = "平滑染色"
L.unitframe_bossColourSmooth_tooltip = "首领的血量根据当前血量百分比染色。"
L.unitframe_enableArena = "启用竞技场框体"
L.unitframe_enableArena_tooltip = "禁用此项如果你想要使用其他的竞技场框体类插件。"
