...
function INVENTORY:CreateRestoreButton(f)
	...
	F.AddTooltip(bu, 'ANCHOR_TOP', L['INVENTORY_RESET'])
...
function INVENTORY:CreateBagToggle()
	...
	F.AddTooltip(bu, 'ANCHOR_TOP', L['INVENTORY_BAGS'])
...
function INVENTORY:OnLogin()
	...
	function MyButton:OnCreate()
		...
		F.SetFS(self.Quest, 'pixel', '!', 'yellow', true, 'TOPLEFT', 2, -2)
	...
	function MyContainer:OnContentsChanged()
		...
		INVENTORY:UpdateAnchors(f.main, {f.ammoItem, f.equipment, f.bagCompanion, f.consumble, f.bagMechagon, f.tradegoods, f.questitem, f.junk})
		INVENTORY:UpdateAnchors(f.bank, {f.bankAmmoItem, f.bankEquipment, f.bankLegendary, f.bankCompanion, f.bankConsumble, f.bankMechagon})
	end
